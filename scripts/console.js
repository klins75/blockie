...
function metrics() {
    ...
    monTwo.innerHTML            = `GRID[${Math.floor(block1.x/GRID_WIDTH)}][${Math.floor(block1.y/GRID_HEIGHT)}]`;
    monTwoScreenKey.innerHTML   = "Current Location";
    monTwoL1.innerHTML          = `X Coord: ${block1.x}`;
    monTwoL1k.innerHTML         = `Y Coord: ${block1.y}`;
    monTwoL2.innerHTML          = "";
    monTwoL2k.innerHTML         = "";
    ...
    monFour.innerHTML           = `Blockie at grid[${Math.floor(block1.x/GRID_WIDTH)}][${Math.floor(block1.y/GRID_HEIGHT)}]`;
